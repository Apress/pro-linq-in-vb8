...
Namespace nwind
    ...
    #End Region
		...
		Public Function CustomersCountByRegion(<Parameter(DbType:="NVarChar(15)")> ByVal param1 As String) As <Parameter(DbType:="Int")> Integer
      Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod, MethodInfo), param1)
		...
		<FunctionAttribute(Name:="dbo.Get Customer And Orders"),  _
		 ResultType(GetType(GetCustomerAndOrdersResult1)),  _
		 ResultType(GetType(GetCustomerAndOrdersResult2))>  _
		Public Function GetCustomerAndOrders(<Parameter(Name:="CustomerID", DbType:="NChar(5)")> ByVal customerID As String) As IMultipleResults
			Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod,MethodInfo), customerID)
			Return CType(result.ReturnValue,IMultipleResults)
		End Function
		
		<FunctionAttribute(Name:="dbo.MinUnitPriceByCategory", IsComposable:=true)>  _
		Public Function MinUnitPriceByCategory(<Parameter(DbType:="Int")> ByVal categoryID As System.Nullable(Of Integer)) As <Parameter(DbType:="Money")> System.Nullable(Of Decimal)
		...
		Public Function ProductsUnderThisUnitPrice(<Parameter(DbType:="Money")> ByVal price As System.Nullable(Of Decimal)) As IQueryable(Of ProductsUnderThisUnitPriceResult)
      ...
      Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod, MethodInfo), beginning_Date, ending_Date)
		...
		Public Function TotalProductUnitPriceByCategory(<Parameter(DbType:="Int")> ByVal categoryID As System.Nullable(Of Integer)) As <Parameter(DbType:="Money")> System.Nullable(Of Decimal)
			Return CType(Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod,MethodInfo), categoryID).ReturnValue,System.Nullable(Of Decimal))
		End Function
		
		<FunctionAttribute(Name:="dbo.Whole Or Partial Customers Set"),  _
		 ResultType(GetType(WholeOrPartialCustomersSetResult1)),  _
		 ResultType(GetType(WholeOrPartialCustomersSetResult2))>  _
		Public Function WholeOrPartialCustomersSet(<Parameter(DbType:="Int")> ByVal param1 As System.Nullable(Of Integer)) As IMultipleResults
			Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod,MethodInfo), param1)
			Return CType(result.ReturnValue,IMultipleResults)
		End Function
	End Class
	
	<Table(Name:="dbo.Alphabetical list of products")>  _
	Partial Public Class AlphabeticalListOfProduct
		...
		<Column(Storage:="_ProductID", DbType:="Int NOT NULL IDENTITY")>  _
    ...
    #End Region
		...
		<Association(Name:="FK_Products_Categories", Storage:="_Products", ThisKey:="CategoryID", OtherKey:="CategoryID", DeleteRule:="NO ACTION")>  _
	...
	<Table(Name:="dbo.Category Sales for 1997")>  _
	...
	<Table(Name:="dbo.Current Product List")>  _
	...
	<Table(Name:="dbo.Customer and Suppliers by City")>  _
	Partial Public Class CustomerAndSuppliersByCity
		...
		<Column(Storage:="_Relationship", DbType:="VarChar(9) NOT NULL", CanBeNull:=false)>  _
    ...
    #End Region
		...
		<Association(Name:="FK_CustomerCustomerDemo", Storage:="_CustomerDemographic", ThisKey:="CustomerTypeID", OtherKey:="CustomerTypeID", IsForeignKey:=true)>  _
		...
		<Association(Name:="FK_CustomerCustomerDemo_Customers", Storage:="_Customer", ThisKey:="CustomerID", OtherKey:="CustomerID", IsForeignKey:=true)>  _
    ...
    #End Region
		...
		<Association(Name:="FK_CustomerCustomerDemo", Storage:="_CustomerCustomerDemos", ThisKey:="CustomerTypeID", OtherKey:="CustomerTypeID", DeleteRule:="NO ACTION")>  _
    ...
    #End Region
		...
		<Association(Name:="FK_CustomerCustomerDemo_Customers", Storage:="_CustomerCustomerDemos", ThisKey:="CustomerID", OtherKey:="CustomerID", DeleteRule:="NO ACTION")>  _
		Public Property CustomerCustomerDemos() As EntitySet(Of CustomerCustomerDemo)
			Get
				Return Me._CustomerCustomerDemos
			End Get
		...
		<Association(Name:="FK_Orders_Customers", Storage:="_Orders", ThisKey:="CustomerID", OtherKey:="CustomerID", DeleteRule:="NO ACTION")>  _
    ...
    #End Region
		...
		<Association(Name:="FK_Employees_Employees", Storage:="_ReportsToEmployee", ThisKey:="ReportsTo", OtherKey:="EmployeeID", IsForeignKey:=true)>  _
		...
		<Association(Name:="FK_Employees_Employees", Storage:="_Employees", ThisKey:="EmployeeID", OtherKey:="ReportsTo", DeleteRule:="NO ACTION")>  _
		...
		<Association(Name:="FK_EmployeeTerritories_Employees", Storage:="_EmployeeTerritories", ThisKey:="EmployeeID", OtherKey:="EmployeeID", DeleteRule:="NO ACTION")>  _
		...
		<Association(Name:="FK_Orders_Employees", Storage:="_Orders", ThisKey:="EmployeeID", OtherKey:="EmployeeID", DeleteRule:="NO ACTION")>  _
		Public Property Orders() As EntitySet(Of [Order])
			Get
				Return Me._Orders
			End Get
    ...
    #End Region
		...
		<Association(Name:="FK_EmployeeTerritories_Employees", Storage:="_Employee", ThisKey:="EmployeeID", OtherKey:="EmployeeID", IsForeignKey:=true)>  _
		...
		<Association(Name:="FK_EmployeeTerritories_Territories", Storage:="_Territory", ThisKey:="TerritoryID", OtherKey:="TerritoryID", IsForeignKey:=true)>  _
    ...
    #End Region
		...
		<Association(Name:="FK_Order_Details_Orders", Storage:="_Order", ThisKey:="OrderID", OtherKey:="OrderID", IsForeignKey:=true)>  _
		...
		<Association(Name:="FK_Order_Details_Products", Storage:="_Product", ThisKey:="ProductID", OtherKey:="ProductID", IsForeignKey:=true)>  _
	...
	<Table(Name:="dbo.Order Details Extended")>  _
	...
	<Table(Name:="dbo.Order Subtotals")>  _
    ...
    #End Region
		...
		<Association(Name:="FK_Order_Details_Orders", Storage:="_OrderDetails", ThisKey:="OrderID", OtherKey:="OrderID", DeleteRule:="NO ACTION")>  _
		...
		<Association(Name:="FK_Orders_Customers", Storage:="_Customer", ThisKey:="CustomerID", OtherKey:="CustomerID", IsForeignKey:=true)>  _
		Public Property Customer() As Customer
			Get
				Return Me._Customer.Entity
			End Get
		...
		<Association(Name:="FK_Orders_Employees", Storage:="_Employee", ThisKey:="EmployeeID", OtherKey:="EmployeeID", IsForeignKey:=true)>  _
		Public Property Employee() As Employee
			Get
				Return Me._Employee.Entity
			End Get
		...
		<Association(Name:="FK_Orders_Shippers", Storage:="_Shipper", ThisKey:="ShipVia", OtherKey:="ShipperID", IsForeignKey:=true)>  _
	...
	<Table(Name:="dbo.Product Sales for 1997")>  _
    ...
    #End Region
		...
		<Association(Name:="FK_Order_Details_Products", Storage:="_OrderDetails", ThisKey:="ProductID", OtherKey:="ProductID", DeleteRule:="NO ACTION")>  _
		Public Property OrderDetails() As EntitySet(Of OrderDetail)
			Get
				Return Me._OrderDetails
			End Get
		...
		<Association(Name:="FK_Products_Categories", Storage:="_Category", ThisKey:="CategoryID", OtherKey:="CategoryID", IsForeignKey:=true)>  _
		...
		<Association(Name:="FK_Products_Suppliers", Storage:="_Supplier", ThisKey:="SupplierID", OtherKey:="SupplierID", IsForeignKey:=true)>  _
	...
	<Table(Name:="dbo.Products Above Average Price")>  _
	...
	<Table(Name:="dbo.Products by Category")>  _
    ...
    #End Region
		...
		<Association(Name:="FK_Territories_Region", Storage:="_Territories", ThisKey:="RegionID", OtherKey:="RegionID", DeleteRule:="NO ACTION")>  _
	...
	<Table(Name:="dbo.Sales by Category")>  _
	Partial Public Class SalesByCategory
		...
		<Column(Storage:="_CategoryID", DbType:="Int NOT NULL IDENTITY")>  _
		Public Property CategoryID() As Integer
			Get
				Return Me._CategoryID
			End Get
	...
	<Table(Name:="dbo.Sales Totals by Amount")>  _
    ...
    #End Region
		...
		<Association(Name:="FK_Orders_Shippers", Storage:="_Orders", ThisKey:="ShipperID", OtherKey:="ShipVia", DeleteRule:="NO ACTION")>  _
		Public Property Orders() As EntitySet(Of [Order])
			Get
				Return Me._Orders
			End Get
	...
	<Table(Name:="dbo.Summary of Sales by Quarter")>  _
	...
	<Table(Name:="dbo.Summary of Sales by Year")>  _
    ...
    #End Region
		...
		<Association(Name:="FK_Products_Suppliers", Storage:="_Products", ThisKey:="SupplierID", OtherKey:="SupplierID", DeleteRule:="NO ACTION")>  _
		Public Property Products() As EntitySet(Of Product)
			Get
				Return Me._Products
			End Get
    ...
    #End Region
		...
		<Association(Name:="FK_EmployeeTerritories_Territories", Storage:="_EmployeeTerritories", ThisKey:="TerritoryID", OtherKey:="TerritoryID", DeleteRule:="NO ACTION")>  _
		Public Property EmployeeTerritories() As EntitySet(Of EmployeeTerritory)
			Get
				Return Me._EmployeeTerritories
			End Get
		...
		<Association(Name:="FK_Territories_Region", Storage:="_Region", ThisKey:="RegionID", OtherKey:="RegionID", IsForeignKey:=true)>  _
	...
	Partial Public Class GetCustomerAndOrdersResult1
	...
	Partial Public Class GetCustomerAndOrdersResult2
	...
	Partial Public Class WholeOrPartialCustomersSetResult1
	...
	Partial Public Class WholeOrPartialCustomersSetResult2
