...
Partial Public Class NwndDataContext
  ...
  #End Region
	...
	Public Sub New()
		MyBase.New(Global.Chapter13.My.MySettings.Default.NorthwindConnectionString, mappingSource)
		OnCreated
	End Sub
	...
	Private Overloads Sub InsertCustomer(ByVal obj As Customer)
		Me.InsertCustomer(obj.CustomerID, obj.CompanyName, obj.ContactName, obj.ContactTitle, obj.Address, obj.City, obj.Region, obj.PostalCode, obj.Country, obj.Phone, obj.Fax)
	End Sub
	
	<FunctionAttribute(Name:="dbo.InsertCustomer")>  _
	Public Overloads Function InsertCustomer(<Parameter(Name:="CustomerID", DbType:="NChar(5)")> ByVal customerID As String, <Parameter(Name:="CompanyName", DbType:="NVarChar(40)")> ByVal companyName As String, <Parameter(Name:="ContactName", DbType:="NVarChar(30)")> ByVal contactName As String, <Parameter(Name:="ContactTitle", DbType:="NVarChar(30)")> ByVal contactTitle As String, <Parameter(Name:="Address", DbType:="NVarChar(60)")> ByVal address As String, <Parameter(Name:="City", DbType:="NVarChar(15)")> ByVal city As String, <Parameter(Name:="Region", DbType:="NVarChar(15)")> ByVal region As String, <Parameter(Name:="PostalCode", DbType:="NVarChar(10)")> ByVal postalCode As String, <Parameter(Name:="Country", DbType:="NVarChar(15)")> ByVal country As String, <Parameter(Name:="Phone", DbType:="NVarChar(24)")> ByVal phone As String, <Parameter(Name:="Fax", DbType:="NVarChar(24)")> ByVal fax As String) As Integer
